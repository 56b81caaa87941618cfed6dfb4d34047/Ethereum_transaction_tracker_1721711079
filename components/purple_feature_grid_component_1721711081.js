...
Vue.component("purple_feature_grid_component_1721711081", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm">Stay ahead of the curve with our cutting-edge technology that scans the Ethereum blockchain for new transactions as they occur, giving you instant access to the latest activity.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            <div id="feature-2-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-2-title-container"><h4 id="feature-2-title" class="flex-1 text-slate-50 font-medium">Advanced Filtering Capabilities</h4></div>
            </div>
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm">Tailor your search to find precisely the transactions you need with our powerful filtering tools. Sort by address, value, gas price, and more to pinpoint the data that matters most.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            <div id="feature-3-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-3-title-container"><h4 id="feature-3-title" class="flex-1 text-slate-50 font-medium">Seamless Integration</h4></div>
            </div>
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm">Effortlessly incorporate our platform into your existing systems and workflows through our comprehensive API, which provides secure and reliable access to transaction data.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            <div id="feature-4-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-4-title-container"><h4 id="feature-4-title" class="flex-1 text-slate-50 font-medium">Insightful Analytics</h4></div>
            </div>
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm">Gain valuable insights into transaction patterns, trends, and anomalies with our robust analytics suite, empowering you to make data-driven decisions and stay ahead of the competition.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            ...
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm">Never miss a beat with our customizable alert system, which notifies you instantly when transactions meeting your specified criteria occur, ensuring you never miss an opportunity.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            ...
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm">Built on a decentralized architecture, our platform offers unparalleled scalability and security, ensuring your data remains safe and accessible, even during periods of high network traffic.</p></div>
        </div>
    </div>`,
        data() {
            return {
